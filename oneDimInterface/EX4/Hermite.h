...
public:
    ...
    void compute_Hmaps();
    void interpPD(Darray2 &u);
    void interpDP(Darray2 &ud);
	Darray2 u,u_interp,ud,ud_interp,umd_interp;
    ...
    void recursion(Darray2 &u_int,Darray2 &um_int,Darray2 &u,int i,double h,double C,double dt);
    void recursion2(Darray2 &u_int,Darray2 &u,int i,double h,double C,double dt);
    void bcMat(double rA,double hr,double *MM,int m_mat);
    void boundaryConditions(int m, double hr,Darray2 &u);
    void laplacian(int m,Darray1 &u,double h);
    void interface(double hu,double hv,double C,double D,double *MM,int m_mat);
    void interfaceConditions(int m,double hu,double hv,double C,double D,Darray2 &u1,Darray2 &u2,int i1,int i2,int iout,int side);
    void oversample(Darray2 &u,int nr,int m,char* fName);
    void arrayCopy(Darray2 &u,Darray2 &v,int is,int ie,int js,int je);
    void boundaryReflection(Darray2 &ud);
};
