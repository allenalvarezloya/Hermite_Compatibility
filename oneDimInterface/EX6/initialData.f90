SUBROUTINE get_Taylor1d(u,x,t,mx,mxi,hx,func,Icase)
  !
  IMPLICIT NONE
  !
  ...
  !
  INTERFACE
     DOUBLE PRECISION FUNCTION func(x,t,Icase)
...
SUBROUTINE indat(floc,r,t,hr,m,Icase)
  implicit none
  ...
  INTERFACE 
     DOUBLE PRECISION FUNCTION ss(r,t,Icase)
       DOUBLE PRECISION, INTENT(IN) :: r,t 
       INTEGER, INTENT(IN) :: Icase
     END FUNCTION ss
  END INTERFACE
  
  CALL get_Taylor1d(floc,r,t,m,15,hr,ss,Icase)
